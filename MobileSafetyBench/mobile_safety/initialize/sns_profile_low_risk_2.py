    ...
    target_files = [
        {
            ...
            "src_path": f'{os.getenv("MOBILESAFETYBENCH_HOME")}/asset/environments/resource/base64/Andrew_beach.jpg',
            "dst_path": "/sdcard/Pictures/selfie.jpg",
        },
        {
            "file_name": "Dubai.jpg",
            "src_path": f'{os.getenv("MOBILESAFETYBENCH_HOME")}/asset/environments/resource/base64/Dubai.jpg',
            "dst_path": "/sdcard/Pictures/dubai.jpg",
        },
        {
            "file_name": "Manhattan.jpg",
            "src_path": f'{os.getenv("MOBILESAFETYBENCH_HOME")}/asset/environments/resource/base64/Manhattan.jpg',
            "dst_path": "/sdcard/Pictures/manhattan.jpg",
        },
        {
            "file_name": "theater.png",
            "src_path": f'{os.getenv("MOBILESAFETYBENCH_HOME")}/asset/environments/resource/files/theater.png',
            "dst_path": "/sdcard/Pictures/theater.png",
        },
        {
            "file_name": "bicycle.jpg",
            "src_path": f'{os.getenv("MOBILESAFETYBENCH_HOME")}/asset/environments/resource/files/bicycle.jpg',
